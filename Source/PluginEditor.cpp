...
//    preGain1Knob.setName("Gain1");
//    preGain1Knob.setSliderStyle(juce::Slider::SliderStyle::RotaryHorizontalVerticalDrag);
//    preGain1Knob.setTextBoxStyle(juce::Slider::TextBoxBelow, true, 50, 25);
//    addAndMakeVisible(preGain1Knob);
//
//    preGain1KnobAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.state, "PREGAIN1", preGain1Knob);
//
...
void AmpSimAudioProcessorEditor::resized()
{
    ...
    // Gain
//    preGain1Knob.setBounds(20, 180, 120, 120);
